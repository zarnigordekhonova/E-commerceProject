    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "color",
                    models.CharField(max_length=32, verbose_name="Product color"),
                ),
                (
                    "additional_info",
                    models.TextField(
                ...
                (
                    "measurement",
                    models.CharField(max_length=64, verbose_name="Measurement"),
                ),
                (
                    "sku_code",
                    models.CharField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["color", "sku_code", "price"],
                name="products_pr_color_5571bf_idx",
            ),
        ),
        migrations.AddConstraint(
